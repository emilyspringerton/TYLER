...
## Build 0125 — S00E01: "Neptune" (SERIES X)
Files: episodes/s00e01_neptune.md, EPISODES.md, activity.md
Jiangshi Syndicate convenes Attempt Five doctrine session. Neptune in Aries named as the doctrine crisis: five-stage binding protocol built on Pisces-Neptune substrate, now obsolete. Adopted: observation-only, no activations, no stage work. NOOR-1 confirmed as Attempt Five field operative. Camera Op contacted; no response yet. Tyler in Pontiac across 4 days: Powderhorn coffee, handles STINKIES trucker hat (reads STORE 0 · PONTIAC MI, replaces it), observes CARTEL sound system installation, deliberate 11-second hum for NOOR-1. Camera Op leaves southern hemisphere, books rideshare to Pontiac at 11:47 PM. Tyler's hum shifts toward 28.7 Hz for 2.7 seconds as she crosses city limits — Eastwind instruments log it; NOOR-1 asleep. Activation #129 self-generating. Venus opposing Camera Op ASC exact at arrival moment. She is 23 miles away. Apple pending.

## Build 0126 — S00E02: "Arrival" (SERIES X)
Files: episodes/s00e02_arrival.md, EPISODES.md, activity.md
First proximity event. Camera Op arrives Pontiac 1:14 AM July 3. Motel room 7. Writes sealed log Entry 23 (4:12), amends it same afternoon (one word crossed, one substituted — first amendments in any sealed log). Morning: breakfast tacos (egg+chorizo ×2, potato) + Powderhorn + ROCKET at Store 0. Transit stop 07:42. Tyler arrives 07:47. Eleven minutes. No conversation. NOOR-1 instruments log 28.7 Hz composite standing wave — full amplitude at T+4:00, fades 90s post-departure. New canon: 28.7 Hz is not Tyler's frequency or hers. It is the interference pattern between them. Mercury direct June 28: path clear. CARTEL test tones travel through sidewalk into motel bed frame at night. Camera Op's eyes open. Camera checked, battery full, card empty. Not touched again. Activation #130 filed: composite/proximity, Δφ=28.7°. Apple pending.

## Build 0127 — S00E03: "July 4" (SERIES X)
Files: episodes/s00e03_july4.md, EPISODES.md, activity.md
First conversation. Camera Op walks into CARTEL (door propped on 4th of July). Tyler walks in. Two stools apart. Bar Manager leaves at 10:18 AM. 22 minutes. No recording exists. Reconstruction from NOOR-1 exterior log + sealed log Entry 24. Tyler said "I know why you came. I'm not going to tell you. Because you already know and hearing it from me would change it." Tyler exceeds 2-second gaze limit person-directed (first time Series X — previously only building-directed). Coin flipped after she leaves. Sealed log Entry 24: 9 minutes 41 seconds, no amendments — longest entry in the full record. Camera Op charges camera battery (already at 94%) when she returns. Jiangshi doctrine meeting concurrent with conversation: contact authorized for tomorrow. NOOR-1: "I think they're about four days behind where they think they are." Apple pending.

## Build 0128 — S00E-1: "The Determination" (SERIES X — bridge episode)
Files: episodes/s00e-1_the_determination.md, EPISODES.md, activity.md
Bridge episode: precedes S00E00 in story chronology (June 18–21, 2026), produced after S00E03. The unwritten scene between Final Memo #081 (Fez, "the Syndicate will make its own determination") and the Pontiac ground state. Jiangshi determination session, June 21 2026, gaveled at the exact solstice ingress minute (Sun Cancer 0°00', 08:24 UTC — room booked three days prior, no ephemeris consulted, no significance assigned). The four attempts read in sequence from the deep archive carts: Attempt One (he does not finish), Attempt Two (he sees you — TYLER-008), Attempt Three (he waits, he chooses), Attempt Four (he cannot be added up — coefficient -1.7, escalation doctrine). Stillness Council appears in writing for the first time in the current cycle: one page, one question — "WHAT DID FOUR ATTEMPTS DOCUMENT?" ARCHIVIST-7 rereads the four failures as a four-line file; Memo #021 (MANIFEST/CONSTRUCT) found already waiting on the retrieval cart, no requester in the ledger — noted, no significance assigned. Corrected assumption adopted and dictated into the minutes: THE OSCILLATION IS THE SUBJECT. TRACK THE OSCILLATION. Determinations: Memo #081 outcomes justify the investment (7–0, Fez operative's assessment adopted, operative stays with the archive); Attempt Four formally archived (SA signs own doctrine's archive order; 40-second pause; duration is data); Attempt Five authorized, method deliberately undeveloped; Neptune substrate question minuted unexamined (the loaded gun S00E01 fires); entry point: Michigan corridor (Jackson/Ann Arbor/Pontiac/Detroit) from natal solar-return anchoring + closing Jupiter-Cancer window + Saturn return horizon Jan 2031; NOOR-1 selected (no Tyler history, no file access): "find him, do not approach, file what is actually there." Tag: STINKIES Store 0 pre-open (awning still boxed, register date set June 21 2026); the Senior Archivist hand-writes "The subject has not changed. The subject never changes." — the sentence S00E00's header inherits. No activations. No hum claimed. Apple pending.

## Build 0129 — INTERLUDE, UNNUMBERED: "The Custody of a Duck" (SERIES X — found footage)
Files: episodes/x00_the_custody_of_a_duck.md, EPISODES.md, activity.md
Continuation of the okemily.com blog transcript "The Duck Also Has Opinions About the Hoodie" — recovered, no camera credit, filed alongside S00E03/S00E-1 but left unnumbered (same convention as field-activation-receipt-unnumbered alongside Activation #114). Tyler leaves the factory carrying the STINKIES COMMISSAIRE hoodie; the duck follows him to a transit stop bench that isn't part of the factory's own geography. Duck reiterates its telekinesis/government-agent claims, covers for the frog again, gets the last word ("I am the chosen one... that part wasn't the pizza talking") without ever being confirmed or denied. Tyler completes no self-defining sentence; the one line closest to it ("I don't calculate. I carry.") describes an action, not an identity, consistent with the standing rule. No hum claimed anywhere in the episode — the one deliberate abstention in its format, since no instrument was running on found footage. STINKIES COMMISSAIRE's real print-vendor decision (S163-03) is referenced but explicitly not resolved fictionally. Apple pending.
