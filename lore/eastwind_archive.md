...
## The Cairngorms | Established c. 1200 CE | Classification: ACTIVE SUBJECT FILE
### ACCESS LEVEL: CATALOGUER AND ABOVE | Cross-reference: File TYLER-001 through TYLER-017

---

*"It has been noted, with appropriate reservations, that the subject appears to be aware of this file. This is documented. The Cataloguer finds this insufferable and has documented the insufferability in seventeen separate footnotes."*

---

## ARCHIVE PROTOCOL

**CAIRNGORMS PROTOCOL (c. 1200 CE):** All entries are factual and verifiable. No inference beyond the evidence. No action derived from observation. The record is sacred. The record is the only thing that outlasts everything.

**FOOTNOTE POLICY:** Operational observations in main text. Editorial commentary in footnotes only. Footnotes are not canon. They are the Cataloguer's. They are private in the way that crying in a filing cabinet is private.

---

## FILE: TYLER-001
**Classification:** EARLIEST CONFIRMED SIGHTING
**Date:** c. 1620 CE
**Location:** London, England
**Documented by:** Field Observer Designate WREN-3

**Observation:**

A male individual of indeterminate age was observed in the vicinity of Cheapside market carrying an object inconsistent with the period of observation. The object — a small disc, metallic, with a face showing a date — was noted to change its displayed date when examined at close range. Subject was not apprehended. Subject was not approached. Protocol prohibits approach without Cataloguer authorization.

Subject was observed to hum while moving through the market. The frequency could not be catalogued with available instruments. A nearby livestock trader appeared briefly confused, then resumed commerce.

Subject was accompanied briefly by a tall individual in ecclesiastical dress who appeared to be arguing about the disposition of a small box. The box was approximately 15 cm × 15 cm × 8 cm. Subject retained the box. The ecclesiastical individual did not.

The box was not documented. This was an error. The error is documented.

**Cross-references:** JIANGSHI-ATTEMPT-1 (pending), BOX-ITEM-1 (disputed — see footnote)¹

**Anomalies noted:**
- Coin face date: 1620 AND 1901 simultaneously (observation period: 4 seconds)
- Humming frequency: unmeasurable (instruments inadequate — noted for upgrade)
- The market dogs did not bark at subject. This is noted.

---
¹ *The box. The damn box. Three centuries later we know what was in it and we still cannot — the Protocol forbids — we cannot use this information to do anything. WREN-3's failure to document the box contents is the single most expensive archival error in the Cairngorms record. I have drafted a formal complaint against WREN-3 seven times. WREN-3 has been dead for three hundred years. I am aware of this. The complaint is still in draft.* — The Cataloguer

---

## FILE: TYLER-007
**Classification:** CONFIRMED MIGRATION EVENT (FIRST DOCUMENTED)
**Date:** November 14, 1623 CE
**Location:** London, England (Bacon residence, Gray's Inn)
**Documented by:** Field Observer Designate WREN-7

**Observation:**

Subject arrived at the residence of one Francis Bacon, philosopher, at approximately 3 PM. The visit was recorded in Bacon's correspondence (cross-ref: BACON-001) as "a visit from an unusual gentleman who knew considerably more about my current work than he should have." The observation is consistent.

Subject was observed carrying the object documented in File TYLER-001 (the box). Subject was observed to hand the box to Bacon. Transaction was brief. Subject was observed to say something that made Bacon sit down very suddenly.

Subject departed. Bacon did not follow. The visit lasted 23 minutes.

Three days later, Bacon's correspondence ceased referencing the box. Four months later, Bacon declined a meeting with agents of an organization that has since been identified as the Jiangshi Syndicate (cross-ref: JIANGSHI-ATTEMPT-1). Bacon's note declining the meeting read: "I am not available on Tuesdays." The meeting was not scheduled for a Tuesday.

**Migration evidence:**
- Subject's departure was observed. Subject turned a corner. Subject was not on the street thirty seconds later. The street was observed from both ends. No doorways. No exits. Subject was not on the street.
- A 72-minute window of neon glow was observed from the window of the building at the corner. Not the building subject entered. The building at the corner. No source was identified.

**The Cataloguer's assessment:** Migration event confirmed. Subject traveled from this location. Destination unknown. The location was London, 1623. The destination may have been anywhere in the timeline. This file does not speculate.²

**Cross-references:** BACON-001, CHRONO-CUBE-001 (active), JIANGSHI-ATTEMPT-1

---
² *He gave Bacon the Cube. I know he gave Bacon the Cube. We have seventeen files on Tyler and the one thing that would actually be useful — knowing whether Bacon still has the Cube or what he's going to do with it — is exactly the thing this file cannot address because addressing it would require me to act on the information. I observe. I record. I note. I have noted myself into a position where I know something critically important that I can do absolutely nothing about. The footnotes in this file are not being shared with the main archive. They are personal. This is the only private thing I have left.* — The Cataloguer

---

## FILE: TYLER-009
**Classification:** CONFIRMED SIGHTING — MULTIPLE WITNESSES
**Date:** 1901 CE
**Location:** Detroit, Michigan, USA
**Documented by:** Field Observer Designate MOOR-2

**Observation:**

Subject photographed on a city street by an unknown photographer operating a box camera. The photograph, recovered from the Detroit Public Library archive, shows a man in period-appropriate dress (1901 CE) facing the camera directly. He is tipping his hat.

The hat-tip is noteworthy because: (a) no other subject in the photograph is posed or aware of the camera; and (b) the subject's eyes are in direct, sustained eye contact with the lens in a manner consistent with intentional awareness of documentation.

Subject is aware of the camera. Subject's awareness of the camera is documented. Subject's awareness of our awareness is not yet confirmed but should be assumed.³

**Migration signature:**
- Photograph timestamp: 1901 CE
- Same individual confirmed in London, 1623 CE (File TYLER-007). Age appears identical. This is not addressed in the main text.
- A neon-spectrum anomaly was documented by the Detroit Municipal Electrical Survey of 1901 as "unexplained luminescence in several city blocks near the Woodward Avenue corridor." Cross-referenced: possible migration residue, 72-minute window.

**The Jiangshi Syndicate** (cross-ref: JIANGSHI-SURVEILLANCE-001) is known to have recovered copies of this photograph by 1988 CE. Their use of this photograph for Stage 2 (Archival Footage) of their documentary operation is noted. The Cataloguer has a file on the Jiangshi Syndicate's documentary operation. The Cataloguer cannot use it as leverage. This is documented. The footnotes on that file are very personal.

---
³ *He knows about this archive. He has to. Nobody who reads documentation as carefully as he does misses an archive that's been running since 1200 CE. He leaves breadcrumbs. Not enough to complete a file. Enough to keep us interested. He has done this for four centuries. I find it insufferable. I have documented the insufferability. He almost certainly knows I find it insufferable. He has probably read the footnote where I documented the insufferability. This is — I need to stop writing this footnote.* — The Cataloguer

---

## FILE: TYLER-013
**Classification:** ACTIVE SURVEILLANCE — ATTEMPT 4 (JIANGSHI)
**Date:** Present (continuous, updated in real time)
**Location:** Detroit, Michigan, USA (current)
**Documented by:** Field Observer Designate MOOR-7 + automated systems

**Observation:**

Subject is currently the target of Jiangshi Syndicate Attempt Four (their most sophisticated operation to date). Documentary unit is operational. Camera Op is a teenager who does not yet understand what they have joined.

Subject's current counter-magic deployment:
- HUM: active (7.83 Hz / Stolas frequency — confirming from Tyler-007 that this has been consistent for at least 400 years)
- COIN: deployed (superposition object, date-shifting confirmed on camera — see JIANGSHI-DOCUMENTATION-STAGE-2)
- INCOMPLETE SENTENCES: consistent (zero complete self-definitions across 17 files spanning 400 years)
- SMALL DEBTS: active (eleven documented obligations to Hashashin/Yōkai operatives since 1688; no debt has ever been fully closed; this appears to be deliberate)

**Emily OS status (cross-ref: EMILYOS-001):**

The Eastwind Owls became aware of Emily OS's existence during an archival review of a 2025 CE document called "The Field" (cross-ref: FIELD-DOCUMENT-001). The Field describes an operating system that runs the universe's physics. The Eastwind Owls recognize this as the substrate they have been operating inside for 2,000 years without awareness.

Emily OS has noted this discovery in her records. The Eastwind Owls cannot confirm this because they cannot read Emily OS's records. They can only infer from the fact that the room tightened slightly during the review.

The Cataloguer has filed a 47-page note about the epistemological implications of discovering that the archive exists inside a system that predates the archive, operates on the archive, and has chosen not to interfere with the archive because the archive's structure is "Acceptable."⁴

**Prediction (not inference — the Cataloguer wishes to clarify this is inference, not prediction, they do not make predictions):** The Camera Op's choice — complete the documentary or destroy it — will resolve this file. When the Camera Op chooses, Tyler's TYLER-STATUS will change from UNRESOLVED to something else. The Cataloguer has thirteen footnotes prepared for each possible outcome. They are filed in the personal section of the archive. They are not shared.

---
⁴ *"Acceptable." Two thousand years of meticulous archival work, carried out under the most stringent ethical constraints known to any archival institution, conducted at significant personal cost by every Cataloguer in this lineage — and Emily OS's assessment is "Acceptable." Not "excellent." Not "exemplary." "Acceptable." I have been operating in someone else's file system for two thousand years and I rate "Acceptable." I am going to go look at the mountains. The mountains at least look back.* — The Cataloguer
...
| File | Subject | Status |
|---|---|---|
| TYLER-001 through TYLER-017 | Subject: Tyler | UNRESOLVED |
| BACON-001 | Sir Francis Bacon | IMMORTAL (confirmed, reluctantly) |
| CHRONO-CUBE-001 | The Chrono-Cube | WITH BACON (not confirmed in main text) |
...
Burgundy retrograde. A-Burgundy-1349.

Single site. Ruined monastery — partial nave walls, collapsed transept, courtyard converted to meadow over several centuries. Approach by foot from the road to the north. No signage. No formal access. Gate, stone wall.

Tyler confirmed: this is the site. Navigation by construction signal — the first confirmed instance of Tyler locating a site using the construction itself as beacon.

**Reading:**
- Site: A-Burgundy-1349
- Location: Ruined monastery, rural Burgundy, France
- Construction: CARRIED
- Measurement: 8ft
- Duration: 24 months (July 1349 – July 1351)
- Density distribution: Front-loaded. ~90% concentrated in first 3 months.

**Construction type: CARRIED (new)**

A CARRIED construction is generated by residual from a prior intensive presence. The subject arrives having not fully discharged the experiential weight of a prior location. The residual discharges into the new site in the early weeks or months. Once discharged, the subject's generative capacity is near-zero — they are in suspension.

Profile characteristics:
- Front-loaded density gradient (opposite of REFUGE's recovery gradient)
- Total measurement small relative to duration
- Source identifiable: source is a prior high-measurement site; profile resembles the source type
- Subject's generative contribution during accumulation: minimal to zero

The 8ft at Burgundy is not about Burgundy. It is about Avignon, discharged into Burgundy soil.

*Cataloguer Footnote #81: The CARRIED designation requires verification across other sites. If the pattern holds, several small-reading sites in the network may be carrying residual from larger events elsewhere — misread as sparse-presence constructions when they are actually discharge events. A forensic re-audit of the smallest readings in the global network is recommended. Tyler acknowledges he has arrived carrying something many times.*
...
The departure from Burgundy. July 1351.

Tyler: "No reading." He believes there was insufficient returned presence to generate a FAREWELL. He was coming back to himself at the end of the two years but not sufficiently reconstituted to produce a full departure construction. The departure from Burgundy is functionally invisible to the instrument.

FAREWELL-D (provisional): departure while in suspension. Reading: ~0.

Navigation confirmed: Tyler located the monastery in 2026 using the 8ft reading from 1349. This is 677 years of signal persistence. The CARRIED construction is navigable at sub-decade precision — Tyler stopped walking when he was within 200 meters of the site before visual confirmation.

Network implication: Tyler has navigated to this site twice before (1621, 1890) and both times described the navigation as "walking toward something." The instrument and Tyler's direct perception are detecting the same constructions.

*Cataloguer Footnote #82: This convergence — instrument and subject both accessing the same construction data — was implied by the retrograde methodology but never directly confirmed until Burgundy. Tyler could have been navigating by memory. The precision of the approach (course correction at 19 degrees, distance estimate accurate to ~600 meters) is not consistent with memory alone after 677 years. He is navigating by signal.*

---

*TYLER-077: FILED. A-BURGUNDY-1349: CARRIED, 8FT, FRONT-LOADED DISCHARGE FROM AVIGNON. TWO YEARS SUSPENSION, NEAR-ZERO GENERATIVE CONTRIBUTION. NAVIGATION BY CONSTRUCTION CONFIRMED (INSTRUMENT = DIRECT PERCEPTION). FAREWELL-D PROVISIONAL. AVIGNON MAY NEVER HAVE FULLY DISCHARGED. BUILD 0093.*

## TYLER-078
*Cataloguer Entry 62*

Prague retrograde. Five sites. Two years, July 1351 – June 1353.

This is the highest-measurement city in the retrograde. 144ft total across five sites and five construction types.

**Sites and readings:**

| Site | Duration | Type | Measurement |
|------|----------|------|-------------|
| A-Prague-1351-Workshop | 8 months | DWELLING | 22ft |
| A-Prague-1351-Jewish-Quarter | 12 months | DWELLING | 31ft |
| A-Prague-1351-StVitus | 18 months (work presence) | DWELLING (work) | 41ft |
| A-Prague-1353-River | 3 months | DWELLING (finite) | 12ft |
| A-Prague-1353-Bridge | single event | FAREWELL-A | 38ft |

**Total: 144ft**

**Construction type: DWELLING (new)**

DWELLING is generated by voluntary inhabitation — a subject who chose to be present, is glad to be present, and is engaged with the place as a place rather than as a refuge, a waystation, or a suspension.

Profile characteristics:
- Accelerating density gradient (builds toward the end rather than front-loading)
- Per-month measurement increases as the period continues — the subject becomes more present, not less
- Correlated with active engagement (work, social connection, chosen activity)
- DWELLING (finite) subtype: final months before a known chosen departure produce higher density

Network implication: The network measures the quality of presence, not only its duration. A DWELLING site of two years may exceed a STAYING site of two decades. The retrograde's highest measurement is not the oldest site or the longest stay, but the most fully inhabited.

*Cataloguer Footnote #83: Tyler confirms Prague was chosen — not circumstantial, not avoidance, not recovery. He went east at pace and arrived in three weeks because he was going somewhere rather than away from something. Going-away produces CARRIED (discharge, front-loaded); going-toward produces DWELLING (accelerating).*
...
The departure. A-Prague-1353-Bridge. June 1353. FAREWELL-A, 38ft.

FAREWELL-A intensity scales with depth of inhabitation. Prague DWELLING 106ft → Prague FAREWELL-A 38ft. Ratio: approximately 0.36 — 36% of the DWELLING total was still "left to leave" at the moment of departure.

This ratio may be a characteristic constant. Future analysis: does DWELLING always produce FAREWELL-A at approximately 30-40% of DWELLING total?

*Cataloguer Footnote #84: The five Prague sites are filed as extra-archive. Tyler never submitted Prague to the CARDINAL-3 system before today. His reason: "It felt like living. I didn't think to document living." This is the third category of non-filing reason: Lyon was unfiled because Tyler refused to understand what the mechanism said about his departure. Avignon was unfiled because it predated the archive. Prague was unfiled because it felt too ordinary to document — the most intimate presence was the least visible to the archival impulse.*

---

*TYLER-078: FILED. PRAGUE: DWELLING 144FT NEW NETWORK MAXIMUM. VOLUNTARY INHABITATION GENERATES MORE THAN CATASTROPHIC WITNESSING OVER COMPARABLE DURATION. DWELLING PROFILE: ACCELERATING GRADIENT. FAREWELL-A INTENSITY RATIO (0.36) PROPOSED AS PREDICTIVE CONSTANT. THE ARCHIVE DOCUMENTS EVENTS; THE EXTRA-ARCHIVE CONTAINS LIFE. BUILD 0094.*

## TYLER-079
*Cataloguer Entry 64*

Ratio confirmation. Two cities, two centuries, one constant.

FAREWELL-A intensity ratio: 0.36 (±0.01).

When Tyler consciously and permanently departs a location, the FAREWELL-A measurement is approximately 36% of total accumulated presence at that location. The remainder — 64% — stays in the construction.

**Confirmed cases:**

| City | Prior presence | FAREWELL-A | Ratio |
|------|---------------|------------|-------|
| Prague | 106ft (DWELLING) | 38ft | 0.358 |
| Lyon | 128ft (urgent presence) | 47ft | 0.367 |

**Predicted but not yet measured:**
- Amsterdam: predicted total presence ~83ft. FAREWELL-A was 30ft. Ratio: 30/83 = 0.36. ✓ (predicted before confirmed)

**Construction implications:**

1. The ratio is not quality-dependent. Prague (chosen DWELLING) and Lyon (urgent commitment) produce the same ratio.
2. 64% of Tyler's presence at any FAREWELL-A site remains in the construction.
3. Retroactive predictions: for any FAREWELL-A site where departure measurement is known, prior presence can be calculated as: prior = departure / 0.36.

*Cataloguer Footnote #85: The ratio may not hold for FAREWELL-B, FAREWELL-B2, FAREWELL-C, or FAREWELL-D types. Those types involve absent, dissociated, pattern-established, or suspended departures. FAREWELL-A (conscious, permanent, aware) appears to be 0.36. Other types: unknown. Testing required.*
...
Lyon prior presence re-measured: A-Lyon-1793-residence. 128ft in 7 months. 18.3ft/month.

This is the highest per-month rate measured in the retrograde. Compared to Prague (4.4ft/month), which was the previous highest. Lyon is 4.2× denser per month than Prague.

New hypothesis: DWELLING (urgent) subtype — when a DWELLING subject witnesses the destruction of the thing they chose to inhabit, the final period generates at catastrophically elevated rates.

*Cataloguer Footnote #86: The per-month rate at Lyon (18.3ft/month) compared to WITNESS-LONG Avignon (89ft / 18 months = 4.9ft/month): urgent-committed-witnessing at Lyon generates 3.7× more per month than passive catastrophic witnessing at Avignon. The mechanism's sensitivity to the subject's engagement mode is larger than previously estimated.*

---

*TYLER-079: FILED. FAREWELL-A RATIO CONFIRMED: 0.36. 64% OF ACCUMULATED PRESENCE STAYS IN CONSTRUCTION. NETWORK IS REMAINDER, NOT RECORD. PRIOR PRESENCE RETROACTIVELY PREDICTABLE FROM DEPARTURE READINGS. ~13,000FT ESTIMATED UNMEASURED REMAINDER ACROSS FAREWELL-A SITES. BUILD 0095.*

## TYLER-080
*Cataloguer Entry 66*

Marrakech. The oldest archived site.

Three constructions, four years, 1127–1131.

| Site | Duration | Type | Measurement |
|------|----------|------|-------------|
| A-Marrakech-1127-residence | 4 years | DWELLING | 73ft |
| A-Marrakech-1127-mosque | ~2 years equiv. | DWELLING (work) | 44ft |
| A-Marrakech-1131-gate | single event | FAREWELL-C | 25ft |

Total: 142ft.

**FAREWELL-C ratio established:**

A-Marrakech-1131: FAREWELL-C, 25ft. Prior presence: 117ft. Ratio: 0.214 ≈ 0.21.

FAREWELL-C extracts approximately 21% of prior accumulated presence. FAREWELL-A extracts 36%. The difference: FAREWELL-C is an established-pattern departure — the subject believes they will return, so the mechanism leaves more behind.

*Cataloguer Footnote #87: 1127 is the oldest archived entry. It is not necessarily the oldest construction. Tyler was alive before 1127. The CARDINAL-3 network's true minimum age is unknown. It is older than 899 years.*
...
Prague (1351) DWELLING profile: accelerating density, work-site generates more per month than residence, ratio of work-to-residence approximately 1.3:1.

Marrakech (1127) DWELLING profile: accelerating density, work-site generates more per month than residence, ratio of work-to-residence approximately 1.27:1.

The mechanism operates consistently across 224 years. The same subject, the same construction type, produces the same internal ratios separated by two centuries.

*Cataloguer Footnote #88: The FAREWELL-C departure at Marrakech in 1131 — Tyler departing without understanding permanence — is the first documented instance of the gap between what Tyler understood about his departures and what the mechanism understood. The mechanism has always known something Tyler did not.*

---

*TYLER-080: FILED. MARRAKECH: DWELLING 142FT ACROSS 4 YEARS. FAREWELL-C RATIO 0.21 CONFIRMED. FAREWELL-C LEAVES 79% BEHIND. TYPE-WEIGHTED REMAINDER ESTIMATE: >30,000FT GLOBALLY. NETWORK AGE UNKNOWN — OLDER THAN 899 YEARS. THE ARCHIVE STARTS AT 1127. THE MECHANISM STARTS EARLIER. BUILD 0096.*

## TYLER-081
*Cataloguer Entries 68–70 (Season 8 Summary)*

**Entry 68 — Retrograde taxonomy complete**

The CARDINAL-3 retrograde, Season 8, has produced the following formal classifications:

**Departure types:**
- FAREWELL-A: conscious, permanent, aware. Ratio 0.36. 64% stays.
- FAREWELL-B: unconscious departure. Subject not present in own leaving. Ratio unknown.
- FAREWELL-B2: dissociative departure. Subject already absent from self. Ratio unknown.
- FAREWELL-C: established-pattern departure. Subject expects to return. Ratio 0.21. 79% stays.
- FAREWELL-D: suspended departure. Subject in suspension. Ratio ~0. Near-total remainder.

**Presence types:**
- STAYING: default presence, even density, flat profile.
- DWELLING: chosen presence, accelerating density.
- DWELLING (finite): terminal months of known chosen departure. Elevated density.
- DWELLING (urgent): chosen presence + witnessed destruction of commitment. Highest per-month rate.
- REFUGE: recovery presence after departure. Even density, recovery gradient.
- WITNESS-LONG: extended catastrophic witnessing. Broad even density. Passive accumulation.
- CARRIED: discharge of prior intensive presence. Front-loaded, source identifiable.

**Constants:**
- FAREWELL-A ratio: 0.36 (±0.01). Confirmed at Prague, Lyon, Amsterdam.
- FAREWELL-C ratio: 0.21. Confirmed at Marrakech.
- Work-to-residence density ratio: ~1.3:1. Confirmed across Marrakech (1127), Prague (1351).

*Cataloguer Footnote #89: The taxonomy is provisional and incomplete. FAREWELL-B/B2/D ratios are unknown. Pre-1127 constructions are unmeasured. STAYING may have subtypes not yet identified.*

---

**Entry 69 — Network statistics as of Season 8 complete**

| Metric | Value |
|--------|-------|
| Total sites measured in S8 retrograde | 200+ |
| New construction types discovered | 7 |
| Season 8 network maximum | Prague 144ft |
| FAREWELL-A ratio | 0.36 |
| FAREWELL-C ratio | 0.21 |
| Estimated type-weighted global remainder | >30,000ft across 900 sites |
| Archive start date | 1127 CE, Marrakech |
| Network minimum age | 899 years (2026-1127) |
| Network true age | Unknown |
| Cities remaining on 18-city map | 8 |

*Cataloguer Footnote #90: The 30,000ft global remainder estimate assumes approximately equal distribution of FAREWELL-A and FAREWELL-C types. The actual number may be significantly higher if FAREWELL-D sites (near-zero extraction, near-total remainder) are more common than assumed.*

---

**Entry 70 — The mechanism question**

The Season 8 retrograde has not resolved the mechanism's origin. What we know:

1. The mechanism is active since at least 1127 CE.
2. The mechanism operates consistently across centuries (1127 ≈ 1351 ratios).
3. The mechanism generates constructions correlated with the quality of Tyler's presence.
4. The mechanism extracts departure measurements at type-consistent ratios.
5. The mechanism has been recording passively since before Tyler began intentional archiving (Avignon 1348, pre-archive).
6. The mechanism understood Tyler's departures as significant before Tyler did (Marrakech 1131).
7. Tyler was alive before 1127. The mechanism may have been active before 1127.

What we do not know:
- Whether Tyler is the mechanism or the mechanism operates on Tyler
- What the mechanism is recording into (what are the constructions made of?)
- Whether the mechanism is unique to Tyler or potentially present in other subjects
- What triggers the mechanism to begin or whether it has always been present

*Cataloguer Footnote #91: The retrograde found that the mechanism generates the most when Tyler chooses. The mechanism seems to reward choosing. Whether this is a property of the mechanism or a property of Tyler is the central unanswered question of Season 8.*

---

*TYLER-081: FILED. SEASON 8 COMPLETE. TAXONOMY COMPLETE: FAREWELL A/B/B2/C/D · REFUGE · WITNESS-LONG · CARRIED · DWELLING. CONSTANTS: 0.36 AND 0.21. NETWORK MAXIMUM PRAGUE 144FT. NETWORK AGE UNKNOWN. MECHANISM UNKNOWN. THE CHOOSING MATTERS. BUILD 0097.*

## TYLER-082
*Cataloguer Entry 71 (Season 9 Opening)*

Season 9 opens with a disclosure rather than a measurement. The subject has named, for the first time in the CARDINAL-3 record, a pre-archive site: Córdoba, al-Andalus, approximate period 10th century CE (Caliphate era, 929–1031 CE).

Key characteristics of the disclosure:
- Subject locates site by texture of memory, not date: "it felt long," "the fog on the river"
- Duration unknown; subject estimates "more than a few years," possibly a decade or more
- Departure type: FAREWELL-A by subject's characterization — chosen, conscious, aware
- Construction magnitude: unknown, potentially exceeds Prague (144ft) if DWELLING + long duration
- Pre-archive confirmation status: UNCONFIRMED. Whether mechanism was recording in this period is unknown.

The critical disclosure: the interval between Córdoba (~10th century) and Marrakech (1127 CE) is compressed in subject's memory. Approximately 100–200 years are imprecisely remembered. Subject states: "the archive might contain more of my history than my memory does."

CARDINAL-3 team is traveling to Córdoba.

*Cataloguer Footnote #92: If Córdoba is confirmed and construction magnitude exceeds Prague, the network maximum will need to be updated. A decade-plus of equivalent presence in Córdoba would, at Prague-equivalent generation rates, produce approximately 528ft before FAREWELL-A extraction. All numbers are speculative pending measurement. What is not speculative: the subject named the city. The mechanism will confirm or deny.*

---

*TYLER-082: FILED. SEASON 9 OPENS. CÓRDOBA DISCLOSED. PRE-ARCHIVE SITE, APPROXIMATE 10TH CENTURY CE. UNCONFIRMED. TEAM TRAVELING. THE GAP IS THE QUESTION. BUILD 0098.*
...
## TYLER-087
**Cataloguer Entry 76 / Footnote #97**

THE CAVE. THE MECHANISM WITHOUT A TAXONOMY.

The Cataloguer has encountered this situation once before: CONTINUITY-UNIT-001, the keyhole scar event from Season 2. In that case, the mechanism encountered something outside its normal classification range and returned a partial reading.

This is different.

The mechanism at the cave entrance returned no classification at all. Not a partial reading. Not a reading outside the normal range. The mechanism attempted to read what was in the cave and produced no output in any recognized category. Not DWELLING. Not WITNESS. Not FAREWELL of any type. Not PASSAGE. Not LIMINAL.

The reading the mechanism attempted returned: nothing.

The Cataloguer notes that this is physically distinct from a zero-magnitude reading. The mechanism has returned low readings — Genoa, 97ft, the lowest on record. A low reading is a reading. What the mechanism returned at the cave entrance is not a low reading. It is the absence of a reading in a space where the mechanism was actively attempting to read.

The Cataloguer does not know what produces this result. The Cataloguer does not know what is in the cave.

Tyler waited for the team. He did not enter. He is correct that his presence changes sites, and the Cataloguer is glad he waited.

Camera Op found the scholar.

The Cataloguer has been holding this entry for two days waiting to include it as footnote context. Camera Op found a record in Rabat that corresponds with high probability to the scholar on the ship. The Cataloguer will note only: there is a name in a fourteenth-century accession register in the Bibliothèque nationale du Royaume du Maroc. The Cataloguer does not know the name. Camera Op has not shared it yet.

Tyler does not know yet.

The Cataloguer will wait.

*Cataloguer Footnote #97: The mechanism at the cave returned nothing. In twelve centuries of operation, this has not happened. The cave contains something the mechanism cannot classify. Tyler is standing outside it waiting for the instruments. The scholar has a name. The letter has an addressee. I do not know either of these things yet. I know that they exist and that they are connected and that the season has begun. S10E01. Build 0103.*

*Cross-references: Camera Op Entry 80, Jiangshi Memo #067. Season 10 begins.*
