...
## 110 Heroes, First Pass — Names, Lore, Intrigue, Backstory
...
top to bottom. Every entry below has one real hook worth expanding; none are meant to be the final
word on the character.

**Docs before software, the Emily Way.** This pass is lore, archetype, and story only — no
abilities, no stats, no roles, no kits. Those get designed later, derived from what's written here,
not stated alongside it. A hero's mechanics should be an argument someone can make from their
history, not a separate track running in parallel to it. This is also, deliberately, why the
foundation matters more than the first attempt at gameplay: if the characters are right and a later
pass at stats/items/abilities turns out wrong, the abilities get regenerated against the same lore.
If the lore were built to fit a stat block instead, a bad first gameplay draft would take the
characters down with it.

**Power-level doctrine:** almost nothing here is a god. The pantheons are real-world source
material, not a roster of deities walking around at full scale — every named figure below is
**demigod-tier**: powerful enough to matter, mortal enough to lose. Roughly a third of the roster is
deliberately **mundane-and-mysterious** rather than mythic-flashy — a person with one strange,
unexplained thing about them, not a pantheon member at all. Tagged per entry as a fact about their
place in the world, not a game statistic: **[MYTHIC]** or **[MUNDANE]**.

**Grounding, not inventing from nothing:** the Jiangshi Syndicate, the Eastwind Owls, the Shell
Parliament, and the Goetia frequency table are already TYLER canon (`README.md`, `CLAUDE.md`,
`lore/`) — those factions below extend real established material. Real-world mythology (Norse,
Chinese, Japanese, Scottish/Celtic, Lovecraftian cosmic horror) is used as source material and
reframed — nearly every entry asks the same question: *what's the version of this figure who lost,
or compromised, or got left out of the story that made them famous.* That's where the actual hooks
live.

---

## FACTION 1 — THE JIANGSHI SYNDICATE (Chinese; hopping-corpse/binding lineage; TYLER canon)

*The organization already running Tyler's containment across the show. Its heroes are archivists,
binders, and the four attempts' worth of institutional scar tissue — the archetype of this whole
faction is bureaucracy that has quietly become the only thing standing between the world and
something none of them fully understand.*

1. **Senior Archivist "Seven Votes"** [MUNDANE] — *The chair who never explains the gavel.* Chaired
   the Attempt Four archive order and the Attempt Five authorization in the same forty-second pause
   (S00E-1) — a pause the minutes record only as "duration is data." No magic of any kind; the power
   is entirely procedural, the ability to freeze any Syndicate action for the length of one gaveled
   session. The scandal is quieter than that: nobody has seen their face outside the deep archive in
   six years, and when a junior clerk asked why, the question itself was struck from that day's
...
2. **ARCHIVIST-7** [MUNDANE] — *The one dissenting vote, twice in a row.* Raised, on the record, the
   ...
   "things the committee didn't adopt but couldn't dismiss." It is, by page count, now longer than
   the official one.
...
4. **The Fez Operative** [MUNDANE] — *Recommended keeping the thing she was sent to end.* Unnamed in
   ...
   it. The scandal isn't that she asked. It's that they said yes.
    *Field signature:* Unmeasurable · Δφ no registered Goetia practice · seed phrase: "recommend retention"

5. **Bacon** [MYTHIC] — *Custodian of the one location nobody's allowed to know yet.* Holds the
   Chrono-Cube's location, confirmed nowhere in the record before a specific dramatic threshold the
   writer's room itself has set. A demigod of withholding by design and by law — every story about
...
12. **The Senior Archivist's Predecessor** [MUNDANE] — *Signed the doctrine the current Syndicate
    ...
    *Field signature:* Unmeasurable · Δφ no registered Goetia practice · seed phrase: "the doctrine before the doctrine"

---

## FACTION 2 — THE GOETIA COURT (72 spirits; TYLER's existing frequency table, extended)

*Already canon: Stolas #36, Beleth #13, Amon #7, Vassago #42, Andrealphus #72 — five frequencies
that already govern real scenes in the show. The archetype of this whole court: a bureaucracy of
...
15. **Amon, Reconciler of Opposites** [MYTHIC] — *A demon whose number is also a law of physics
    ...
    has decided this is either the most important fact about him or entirely irrelevant, and hasn't
    settled which.
...
26. **Ipos, the Half-Answer** [MYTHIC] — *Knows everything and tells you half of it, on principle.*
    ...
    at once.
    *Field signature:* 12.5 Hz · Δφ reported differently to every petitioner · seed phrase: "half the answer, all of the time"

---

## FACTION 3 — THE VALHALLA REMNANT (Norse)

*Not Odin's court at full strength — its exiles, debts, and the things that outlived the mead hall.
...
27. **Herja, Last Valkyrie Off the List** [MYTHIC] — *Chose the slain for nine centuries, then
    ...
    redirecting the honored dead for longer than most of Valhalla's current residents have been
    there.
...
35. **The Bifrost's Off-Duty Watchman** [MUNDANE] — *Takes the shift Heimdall doesn't want.* No
    magic — extraordinary eyesight, extraordinary aim, and a deep, unresolved exhaustion with a job
    that never actually ends, because someone always has to be watching the bridge.
...
46. **The Eight Immortals' Ninth Applicant** [MYTHIC] — *Rejected, and three different accounts of
    ...
    *Field signature:* contested — three readings, none agree · Δφ three different values recorded · seed phrase: "reject him consistently, at least"

---

## FACTION 5 — THE RISING SUN CIRCUIT (Japanese: yokai, kami-adjacent, oni)
...
56. **Kappa, River Debt Ledger** [MUNDANE] — *Keeps score of who bows and who doesn't.* The
    ...
    *Field signature:* 1.1 Hz · Δφ 23° — Golden Band · seed phrase: "the bow that wasn't given"

---

## FACTION 6 — THE HIGHLAND COURT (Scottish/Celtic)
...
67. **Puck, Between the Play and the Folklore** [MYTHIC] — *Robin Goodfellow existed in English
    ...
    laugh — got a specific, enormously influential retelling in *A Midsummer Night's Dream*, and has
    never quite escaped it since. Every account of him now argues, implicitly, about which version is
    the real one: the older, wilder hobgoblin of the folklore, or the wry, stagecraft-aware fairy who
    gets the play's own closing lines and seems to know he's in one. This roster doesn't resolve that
    either — a trickster whose defining trick, at this point, might be making everyone forget he
...
68. **A Deep One, Newly Surfaced** [MYTHIC] — *Innsmouth-lineage, and surfaced for a reason the
...
69. **Leviathan's Appointed Harbormaster** [MUNDANE] — *Manages the sea monster's territorial
...
70. **Behemoth's Grazing-Rights Negotiator** [MUNDANE] — *Decides where a walking catastrophe is
...
71. **A Star-Spawn, Off Mission** [MYTHIC] — *Sent to observe. Started acting anyway, in small,
...
72. **The Choir's Human Translator** [MUNDANE] — *No abyssal blood at all — just the only person who
...
73. **A Byakhee, Grounded** [MYTHIC] — *An interstellar mount-creature, stranded on the surface and
...
74. **The Last Sane Cultist** [MUNDANE] — *Read the forbidden text, understood it completely, and
...
75. **Dagon's Reluctant Herald** [MYTHIC] — *Announces the deep god's will, and quietly edits the
...
76. **A Thing From the Cold Waste, Thawed Early** [MYTHIC] — *Woke up before its cycle should have
...
77. **The Choir's Cartographer of Places That Shouldn't Connect** [MUNDANE] — *Maps non-Euclidean
...
78. **Cain, East of Eden** [MYTHIC] — *The first murder, and a mark that is a curse and a
    ...
    would be permitted to kill him in turn. The oldest example on this entire roster of a punishment
    that is also, unmistakably, a mercy, and scripture never resolves which one it actually is. Went
    on, after the exile, to found the first city (Enoch, named for his son) — the single most
    understated line in the whole account: the man cast out to wander settled down and built
    civilization anyway. Placed with the Abyssal Choir not because he belongs to their horror, but
    because he is the oldest primordial exile on the list, and every other entry in this faction is,
    in its own way, about something ancient trying to find where it's allowed to stand.
    *Field signature:* Predates the Field · Δφ no instrument reaches this far back · seed phrase: "the mark that is also a mercy"

---

## FACTION 8 — THE SHELL PARLIAMENT (Heikegani Crustocrats; TYLER canon, financial/steampunk)
...
79. **The Ledger-Duke of the Long Invoice** [MUNDANE] — *An entire life built on unpaid favors.* No
...
80. **A Heikegani Underwriter, First Class** [MUNDANE] — *Prices risk on things that shouldn't be
...
81. **The Crustocrat Who Wouldn't Foreclose** [MYTHIC] — *Held a debt against a demigod for two
...
82. **The Shell Parliament's Actuary of Impossible Odds** [MUNDANE] — *Calculates probabilities for
...
83. **A Junior Clerk, Promoted by Accident** [MUNDANE] — *Filed one form correctly during a crisis
...
84. **The Parliament's Repossession Specialist** [MYTHIC] — *Collects on the debts the Ledger-Duke
...
## FACTION 9 — THE EASTWIND OWLS (Archive Wardens; TYLER canon)

*Already TYLER canon. The archetype: an observation-only doctrine, and the specific cost of actually
following it.*

85. **An Eastwind Owl, Vassago-Frequency** [MYTHIC] — *Already TYLER canon — 11.11 Hz, soft
...
86. **The Owl Who Broke Protocol Once** [MUNDANE] — *Intervened, exactly once, against doctrine —
...
87. **A Field Archivist, Twelve Sites In** [MUNDANE] — *No magic — just an encyclopedic, slightly
...
88. **The Owl Who Logs the Owls** [MUNDANE] — *A meta-archivist, auditing the archivists.* Feared by
...
89. **MOOR-8's Predecessor** [MYTHIC] — *Filed the sealed-log system before it was standard
...
90. **A Newly Recruited Owl, Still Flinching at the Hum** [MUNDANE] — *The rookie, deliberately.*
    ...
    ethos.
    *Field signature:* 11.11 Hz · Δφ 14°, rising with practice · seed phrase: "still flinching at the hum"

---

## FACTION 10 — THE SPRINGERTON ENGINE (high-tech/steampunk; Emily OS-adjacent constructs)

*Not Emily OS herself — she doesn't explain herself and isn't a hero pick. These are things built
near her, in her idiom: brass, code, and a frequency table wearing gears instead of robes. The
archetype: technology that grew up next to something it doesn't fully understand, and has learned
to work anyway.*

91. **A Golden Band Construct, First Casting** [MYTHIC] — *Built to a real spec, and strongest only
...
92. **The Architect's Orb Custodian** [MUNDANE] — *Maintains the terminal. Isn't the terminal.*
...
93. **A Chrono-Cube Technician, Uncleared** [MUNDANE] — *Works next to something she isn't cleared to
...
94. **The Towerprint Cartographer** [MYTHIC] — *Fingerprints identity itself.* Named for a real
...
95. **A CAST-Reconnect Technician** [MUNDANE] — *Invisible by design, and good at it.* Per the
...
96. **The Steam-Driven Ledger Automaton** [MYTHIC] — *Built to cross-reference two factions' records,
...
97. **A Layer 9 Line Technician** [MUNDANE] — *Holds a line to something he's never heard answer.*
...
98. **The Field Activation Log's Human Numbering Authority** [MUNDANE] — *Decides what gets a number
...
99. **A Golden Band Second Casting, Malfunctioning** [MYTHIC] — *Built to the same spec as #89, and
...
100. **The Emily OS Tile Custodian** [MUNDANE] — *Cares, obsessively, for one small, specific thing.*
...
101. **A Duck, Reportedly Telekinetic** [MYTHIC/MUNDANE — genuinely both, on purpose] — *Claims
...
102. **The Unicorn, Allegedly a Robot** [MYTHIC/MUNDANE — both, on purpose] — *Was eating spaghetti
    ...
    transcript notes the duck's "that's impossible" was aimed at itself, not the unicorn — the two
...
103. **The Ghost, Self-Identified as Alien** [MYTHIC] — *Was playing the piano when it clarified it
    ...
    simpler: a ghost that plays piano and an alien that plays piano are, mechanically, doing the
    exact same thing, and the distinction turns out to matter only to the one making the claim.
    *Field signature:* identical whether logged as ghost or alien · Δφ 29°, unremarkably clean · seed phrase: "the piano doesn't care what you call it"

104. **The Frog, Keeper of a Secret It Won't Share** [MYTHIC] — *Wearing a top hat, claims to know
    ...
    whose defining trait (holding a real secret) has never once been tested, contradicted, or paid
    off — a hero built entirely on a promise the transcript has no obligation to keep.
    *Field signature:* instrument declines to report · Δφ out of apparent solidarity with the source · seed phrase: "[withheld, matching the secret]"

105. **The Tree, Speaking French** [MYTHIC] — *Claims to be the keeper of the universe's greatest
    ...
    a language none of the other witnesses on record are shown understanding.
    *Field signature:* reading exists · Δφ recorded in French, untranslated · seed phrase: "[in French, untranslated, deliberately]"

106. **The Pizza, On Fire, Uninvestigated** [MUNDANE] — *"I am the chosen one." Then: on fire. Nobody
    ...
    never been argued with by anyone else in the cast, including the duck, the unicorn, the ghost,
    the frog, or the tree. Whether that's because it's true or because nobody thought a burning pizza
    was worth the argument is exactly the kind of question this whole faction was built to leave
    open.
    *Field signature:* warm · Δφ that's the whole reading · seed phrase: "chosen, apparently, and on fire"

107. **The Custodian of the Hoodie** [MUNDANE] — *Whoever ends up holding the thing the duck's story
    ...
    *Field signature:* Unmeasurable · Δφ no registered Goetia practice · seed phrase: "you are owed something now"

---

## FACTION 11 — THE UNBOUND HISTORICALS (real legendary humans, mythologized after the fact)

*Founder-added. Distinct from every other faction here: these are documented, real people first —
the myth was built around them later, sometimes centuries later, sometimes by people with something
to gain from the myth existing. The archetype: the gap between the actual, mundane historical record
...
108. **Nicholas Flamel, Scrivener** [MYTHIC/MUNDANE — genuinely both, on purpose] — *The real man
    ...
    to churches and hospitals, and entirely unremarkable as an alchemist during his own lifetime. The
    legend of the Philosopher's Stone and eternal life didn't attach to his name until the 1600s,
    two centuries after his death, built by people who found an old, successful scrivener's estate
    a more interesting story than an old, successful scrivener. This roster's version leans directly
    into that gap rather than resolving it: is he a mundane man whose quiet, real prosperity got
    mistaken for magic by people who needed it to be — or is he the one figure on this entire list
    who let a false legend become load-bearing cover for something real, and has had three hundred
...
109. **Nikola Tesla, the Unfinished Tower** [MYTHIC] — *Died in debt, in a hotel room, with the
    ...
    Island, built to broadcast electricity and information to the whole world at once, abandoned
    mid-construction when J.P. Morgan pulled funding rather than back a system nobody could meter and
    bill for. The tower was demolished for scrap in 1917. Tesla spent his final years in increasing
    poverty and isolation — feeding pigeons, refusing to shake hands, claiming (on the record, to
    reporters, more than once) to have received a signal from Mars — and died alone in 1943; the FBI
    seized his papers within hours, officially over wartime national-security concerns, and a
    meaningful portion of what was taken has never been made fully public. Every other figure on this
    roster who's defined by an unfinished thing (Ahmad's sentence, the duck's debt) is fiction. This
    one is a real, unfinished tower that's still, legally, a historical footnote instead of the
    infrastructure it was built to become — the single most steampunk-coded fact on the entire list,
...
110. **Ada Lovelace, Pilot** [MYTHIC] — *Wrote the first computer program for a machine that was
    ...
    written for a general-purpose computer, for hardware that existed only on paper. She called her
    own approach "poetical science," insisting mathematics and imagination were the same discipline
    practiced two ways, and died at thirty-six, decades before anything resembling the Engine was
    ever actually constructed. This roster's reframe is a single deliberate anachronism, stated
    plainly rather than hidden: give her, in this multiverse alone, the machine she only ever had on
    paper — cast as a mech pilot, someone who wrote the operating logic for a frame before the frame
    existed and is, now, the only person alive who's read the manual cover to cover. Every other
    entry earns its steampunk credentials from unfinished infrastructure (Tesla's tower) or borrowed
    magic (the Golden Band constructs). She earns hers from a woman who was right about a machine
...
- Real mythology (Factions 1–10) and real history (Faction 11) are both used as source material and
  reframed, not transcribed — nearly every entry above takes a real figure or role and asks what the
  version of them who lost, compromised, got left out of the story, or had a myth grow past them
  would actually be like.
- Faction 11 (Flamel, Tesla, Lovelace) is a different kind of grounding than Factions 1–10: not myth
  reframed, but documented history left almost entirely alone, because the real record is already
  stranger and more unresolved than anything invented could be (a real unfinished tower, a real
  three-centuries-late legend, a real program written for hardware that didn't exist yet). More real
  historical figures belong here on a future pass.
...
- **Field signatures added 2026-07-23** to all 110 entries, using the exact apparatus already
  ...
  already exist (Stolas 7.83, Beleth 2.22, Amon 1.618, Vassago 11.11, Andrealphus 31.41, Bael 0.33,
  Agares 0.51); every Eastwind Owl inherits Vassago's 11.11 Hz per existing canon; mundane/human
  entries correctly read "no registered Goetia practice" rather than being assigned a fake number;
  entries whose lore is explicitly broken or contested (the malfunctioning Golden Band casting, the
  liar Furfur, the three-contradictory-accounts Ninth Applicant) get Δφ readings outside the Golden
  Band or explicitly disputed, on purpose; Tesla gets 60 Hz — real AC power frequency, not invented,
  the one signature in the whole document that's a coincidence of actual history rather than a
  choice; the Faction 10 duck-and-company cast get deliberately inconsistent or half-refused
  readings, matching their own source material's refusal to confirm or deny anything. This is a
  first pass at the apparatus, same as the lore itself — not a claim that every value is final.
- Deliberately no abilities, stats, roles, or kits anywhere in this document. Mechanics get designed
