...
- `[ ]` Pending
- `[x]` Complete
- `[~]` In progress (loop may be mid-iteration)

**Task format:** Each item is one build — one atomic RSI task that produces a coherent commit.
The task description includes: what to generate, which faction files receive receipts, and any
load-bearing dependencies that must exist first.
...
- [x] **Tides Book 1 Chapters 2–12** — Complete (tides_book1_ch04_07.md + tides_book1_ch08_12.md).
  Ch8: all three vertices in one room first time. Ch9: love triangle detonation — one resolution
  (east hallway confirmed real), one complication (Callum holds info Protagonist A didn't consent
  to), one open wound (incomplete thing between A and B). Ch10: Tyler in library, page 847,
  New Atlantis. Ch11: grandfather's account — "custodian," 1623, Edinburgh 1981. Ch12: dry
  interval begins; Tyler final scene — "the island is not in the text"; Protagonist A writes
...
- [x] **Emily Stillness Parts VI–VII** — Complete (emily_stillness_parts6_7.md). Part VI:
  map the session before the session; measure backward not forward; protect load-bearing
  sessions; the visibility problem; the 30-year question. Part VII: the permanent condition;
  the 30-year build; why not to wait ("the readiness is built by starting"); the clean build
  is the only unit you can control; "the sequence is correct." Book complete.
...
- [x] **S08E12: "Prague"** — DWELLING construction. 5 sites, 144ft total — NEW NETWORK MAXIMUM. A-Prague-1351-Workshop (DWELLING 22ft), A-Prague-1351-Jewish-Quarter (DWELLING 31ft), A-Prague-1351-StVitus (DWELLING work 41ft), A-Prague-1353-River (DWELLING finite 12ft), A-Prague-1353-Bridge (FAREWELL-A 38ft). July 1351–June 1353. Voluntary inhabitation > catastrophic witnessing. DWELLING accelerates over time (vs STAYING flat). Network measures quality of presence not duration. Archive = events; extra-archive = life. FAREWELL-A intensity ratio 0.36: departure ≈ 36% of prior DWELLING total. Tyler: "I have been managing exits, not inhabiting arrivals." Build 0094. Apple #508. Done 2026-06-14.
- [x] **S08E13: "The Ratio"** — FAREWELL-A constant confirmed: 0.36 (±0.01). Prague 0.358, Lyon 0.367, Amsterdam retroactively 0.36. 64% remainder theorem: 64% of accumulated presence stays in construction; 36% leaves with Tyler. Network = inventory of Tyler's losses, not record of presence. Lyon prior: 128ft in 7mo (18.3ft/month, highest per-month in retrograde, 4.2× Prague). DWELLING(urgent) proposed: commitment + witnessed destruction of commitment. ~13,000ft estimated unmeasured remainder in ~300 FAREWELL-A archive sites. Build 0095. Apple #509. Done 2026-06-14.
...
- [x] **S10E08: "Fez, December 1119"** — Ahmad deposits the manuscripts at al-Qarawiyyin and
